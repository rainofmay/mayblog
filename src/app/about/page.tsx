        ...
        <ul>
          ...
          <li>
            <h3>
              ...
              BA Strategy Naval Academy (2015)
            </h3>
          </li>
          <li>
            <h3>
              <FontAwesomeIcon icon={faPen} size="1x" />
              Officer (2015~2024) <br />
              Planning for 3 years as a department head in brigade level
              organizations
            </h3>
          </li>
          <li>
            <h3>
              <FontAwesomeIcon icon={faPen} size="1x" />
              Co-representative of CLED
            </h3>
            <p>
              Planner <br />
              Front-End(React, Next.js) Developer & Publisher
            </p>
          </li>
          <li>
            <h3>
